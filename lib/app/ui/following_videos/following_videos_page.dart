...
class FollowingVideosPage extends GetView<FollowingVideosController> {
  const FollowingVideosPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (controller.followingsAllVideosList.isEmpty) {
          return const Center(
        ...
        return PageView.builder(
            itemCount: controller.followingsAllVideosList.length,
            controller: PageController(initialPage: 0, viewportFraction: 1),
            scrollDirection: Axis.vertical,
            itemBuilder: (context, index) {
              final eachVideo = controller.followingsAllVideosList[index];
              return Stack(
                children: [
                  CustomVideoPlayer(
